...
const EventCard = ({ event }: { event: (typeof upcomingEvents)[0] & { isPast?: boolean, description?: string } }) => {
  ...
  return (
    <Card className="bg-card border-border/50 overflow-hidden flex flex-col group hover:border-primary transition-all duration-300 transform hover:-translate-y-1">
      ...
      <CardContent className="p-3 flex-grow">
        ...
        {event.description && (
          <p className="text-sm text-foreground/80 leading-relaxed border-l-2 border-primary/50 pl-3 italic">
            {event.description}
          </p>
        )}
      </CardContent>
...
export default function EventsPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[70vh] md:h-[93vh] overflow-hidden bg-black">
